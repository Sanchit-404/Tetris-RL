...
from tetris_obstacles import Tetris
...
wandb.init(project="tetris-ppo", entity="sanchit278")
...
def dqn():
    ...
    # Create an ACAgent instance
#    agent = ACAgent(state_size=env.get_state_size(), n_neurons=n_neurons, activations=activations, epsilon_stop_episode=500, mem_size=10000, discount=0.95)
	# Train the agent
    ...
    for episode in tqdm(range(episodes)):
        ...
        if log_every and episode and episode % log_every == 0:
            ...
            log.log(episode, avg_score=avg_score, min_score=min_score,
                    max_score=max_score)
            wandb.log({
                "episode": episode,  # This should be the first key
                "total_reward": reward,
